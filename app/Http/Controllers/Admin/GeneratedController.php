...
{
    protected $elementsList = 'admin.menu.elements-list';
    protected $createMenu = 'admin.menu.create-menu';
    protected $editMenu = 'admin.menu.edit-menu';
    protected $childList = 'admin.menu.child-list';
    protected $menuCart = 'admin.menu.menu-cart';

    public function index()
    {
        $view = $this->elementsList;
