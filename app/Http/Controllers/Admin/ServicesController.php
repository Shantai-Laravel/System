...
{
    //base views
    public $createView = 'admin.services.create';
    public $showView   = 'admin.services.show';
    public $editView   = 'admin.services.edit';

    public $foreignKey = 'services_id';
    public $modelTrans = 'App\Models\Service';
    public $model      = 'App\Models\ServiceId';
    ...
    public function save($id, $updated_lang_id)
    {
        ...
        if(is_null($id)){
            ...
            $data = array_filter([
                ...
                'body' => Input::get('body'),
                'img' => $img,
                'item1' => Input::get('item1'),
                'item2' => Input::get('item2'),
                'item3' => Input::get('item3'),
                'item4' => Input::get('item4'),
                'meta_title' => Input::get('meta_title'),
                'meta_keywords' => Input::get('meta_keywords'),
                'meta_descr' => Input::get('meta_description')
            ]);
