...
{
    //base views
    public $createView = 'admin.promotions.create';
    public $showView   = 'admin.promotions.show';
    public $editView   = 'admin.promotions.edit';

    public $foreignKey = 'promotion_id';
    public $modelTrans = 'App\Models\Promotion';
    public $model      = 'App\Models\PromotionId';
